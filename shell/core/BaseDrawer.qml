...
PanelWindow {
    ...
    anchors {
        bottom: edge === Qt.BottomEdge || (cornerMode && cornerSecondaryEdge === Qt.BottomEdge)
        left: edge === Qt.LeftEdge || (cornerMode && cornerSecondaryEdge === Qt.LeftEdge)
        right: edge === Qt.RightEdge || (cornerMode && cornerSecondaryEdge === Qt.RightEdge)
        top: edge === Qt.TopEdge || (cornerMode && cornerSecondaryEdge === Qt.TopEdge)
    }
    margins {
